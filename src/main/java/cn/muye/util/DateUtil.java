...
import cn.muye.constants.Constants;
...
public class DateUtil {
    ...
    public static DateFormat dateTimeMISFormat = null;
    // 默认显示日期时间的格式 精确到毫秒
    ...
    public static String getTimeRandom() {
        ...
        int id = rd.nextInt(9999-1000+1)+1000;
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmssMM");
        return sdf.format(in_time)+String.valueOf(id);
    }
